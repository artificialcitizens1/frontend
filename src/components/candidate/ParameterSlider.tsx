...
export const ParameterSlider = ({ label, value, onChange }: ParameterSliderProps) => {
  ...
  return (
    <div className="flex flex-col items-start gap-2 w-full">
      <span className="text-white/80 text-[16px] font-medium font-['Inter']">{label}</span>
      <div className="flex items-center gap-[11px] w-full">
        ...
        <div className="relative flex-1 h-[6px] cursor-pointer" onClick={handleSliderClick}>
          {/* Track */}
          <div className="absolute w-full h-full border border-[#4B4761]" />

          {/* Fill */}
          <div className="absolute h-full bg-[#48465D]" style={{ width: `${value * 100}%` }} />
