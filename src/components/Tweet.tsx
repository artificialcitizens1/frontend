...
// ==========================================
const CommentsSection = ({ comments }: { comments: CommentProps[] }) => {
  return (
...
// TWEET COMPONENT
// ==========================================
const Tweet = ({ avatar, name, username, time, content, image, likes, verified, commentCount, comments }: TweetProps) => {
